        ...
        <div className={styles.container}>
            ...
            <div className={styles.content}>
                <section className={styles.section}>
                    <h2 className={styles.sectionTitle}>Merhaba! 👋</h2>
                    <p className={styles.text}>
                        Ben yazılım geliştirme tutkunu bir geliştiriciyim. Bu blogda yazılım,
                        teknoloji ve öğrendiklerimi paylaşıyorum. Amacım, karmaşık konuları
                        herkesin anlayabileceği şekilde açıklamak ve toplulukla bilgi paylaşmak.
                    </p>
                </section>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.skills}>
                        {['React', 'Next.js', 'TypeScript', 'Node.js', '.NET', 'C#', 'SQL', 'DevOps'].map((skill) => (
